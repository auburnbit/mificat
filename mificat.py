...
def connector_loop_thread():
    '''Runs in thread t1 and coordinates quiz and RAM editing logic'''

    global ene_mem_read
    global exp_mem_read
    global gil_mem_read
    
    global pm1_exp_mem_read
    global pm2_exp_mem_read
    global pm3_exp_mem_read
    global pm4_exp_mem_read

    global quiz_ecf_mem_read
    global quiz_flag29_currently_quizzing
    global quiz_flag30_correct_answer
...
def read_ram_loop_thread():
    '''
    Runs in thread t2 and reads relevant RAM values from external process
    '''
    global ene_mem_read
    global exp_mem_read
    global gil_mem_read
...
t1 = threading.Thread(target=connector_loop_thread)
t2 = threading.Thread(target=read_ram_loop_thread)
